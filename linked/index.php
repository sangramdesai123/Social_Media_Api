...
<?php if ((!isset($_SESSION['member_id']))||(!$success &&  !$_SESSION["member_id"])) { ?>  
<?php if(!empty($error)) { ?>
...
<?php } 
        ...
        <div id="profile-outer">
                ...
                <div class="profile-row">
                    <span class="profile-info"><?php echo $user->emailAddress; ?></span>
                </div>

                <div class="profile-row">
                    <span class="profile-info"><?php echo $user->id; ?></span>
                </div>
